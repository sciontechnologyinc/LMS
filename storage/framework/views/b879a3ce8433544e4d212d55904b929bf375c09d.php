...
<?php endif; ?>
 ...
 <?php endif; ?>
    ...
    <a class="btn btn-primary col-lg-2 offset-9" href="<?php echo e(url('addsection')); ?>" style="margin-bottom: 10px;">Create New</a>
                  ...
                  <thead>
                    ...
                    <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        ...
                        <a rel="tooltip" title="Edit" class="btn btn-success btn-sm mr-1" href="sections/<?php echo $section->id; ?>/edit"><i class="fa fa-edit"></i></a>
                        <?php echo Form::open(['id' => 'deleteForm', 'method' => 'DELETE', 'url' => '/sections/' . $section->id]); ?>
