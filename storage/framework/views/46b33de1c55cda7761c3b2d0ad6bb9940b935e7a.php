...
<?php $__env->startSection('title','Dashboard'); ?>
  ...
  <div class="col-sm-6 col-lg-3">
     <div class="card text-white bg-flat-color-1">
         <div class="card-body pb-0">
             ...
             <h4 class="mb-0">
             <span class="no-padding center mt txt-sm count"><?php echo e($t_sections); ?></span> 
             </h4>
             <a href="<?php echo e(url('sections')); ?>"><p class="text-light">Sections</p></a>
 ...
 try{
     ...
     $link = new \PDO(   'mysql:host=127.0.0.1;dbname=lmsculiat;charset=utf8mb4', //'mysql:host=localhost;dbname=canvasjs_db;charset=utf8mb4',
                        'lmsroot', //'root',
                        '123456', //'',
                        array(
