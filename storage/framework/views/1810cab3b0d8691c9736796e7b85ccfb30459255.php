...
<?php endif; ?>
 ...
 <?php endif; ?>
  ...
  <?php echo Form::open(['id' => 'dataForm', 'method' => 'PATCH', 'url' => '/sections/' . $section->id ]); ?>
                          ...
                          <div class="form-group">
							<div class="form-group col-md-6 offset-2">
                                ...
                                <i class="fa fa-list-alt"></i></span>
									<?php echo Form::text('sectionname',$section->sectionname, ['placeholder' => 'Section Name', 'class' => 'form-control col-lg-12' ]); ?>
                                ...
                                <br>
                                <?php echo Form::submit('Update Section', ['class' => 'btn btn-primary  col-lg-2 offset-8']); ?>
