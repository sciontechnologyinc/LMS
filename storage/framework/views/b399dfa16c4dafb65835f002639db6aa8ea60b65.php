                  ...
                  <thead>
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        ...
                        <a rel="tooltip" title="Edit" class="btn btn-success btn-sm mr-1" href="administrators/<?php echo $user->id; ?>/edit"><i class="fa fa-edit"></i></a>
                        <?php echo Form::open(['id' => 'deleteForm', 'method' => 'DELETE', 'url' => '/administrators/' . $user->id]); ?>
