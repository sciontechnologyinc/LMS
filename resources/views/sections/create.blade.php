...
@endif
 ...
 @endif
    ...
    {!! Form::open(['id' => 'dataForm', 'url' => '/sections']) !!}
    <div class="col-lg-12">
                    <div class="card">
                          ...
                          <div class="form-group">
							<div class="form-group col-md-6 offset-2">
                                ...
                                <i class="fa fa-building"></i></span>
									{!!Form::text('sectionname',null, ['placeholder' => 'Section Name', 'class' => 'form-control col-lg-12', 'required' => '' ])!!}
								</div>
							</div>
						</div>
                                <br>
                                {!!Form::submit('Create Section', ['class' => 'btn btn-primary  col-lg-2 offset-7']) !!}
